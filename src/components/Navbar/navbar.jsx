     ...
     <nav className='flex justify-between pt-6 xl:px-20 md:px-9 px-2'>
        <div className='md:w-[10rem] xl:w-fit w-[10rem]'>
          <img src={Logo} alt="nav-brand" className='w-full' />
            ...
            <div onClick={() => handleIsOpen()} ref={menuRef} className='md:relative fixed top-0 left-0 z-10 md:bg-inherit md:bg-[#A02279] bg-[#222] md:p-0 md:h-0 h-full p-10'>
        ...
        <div className='leading-10'>
          ...
          <button className='md:hidden block mr-2' onClick={() => handleIsOpen()}>
            <img src={Menu} alt='' />
          </button>
        </div>
